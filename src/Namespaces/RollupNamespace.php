 ...
 * Date: 2022/4/15 15:46:44
 */
declare(strict_types=1);

namespace LavaMusic\ElasticSearch\Namespaces;

use LavaMusic\ElasticSearch\Endpoints\Rollup;
...
class RollupNamespace extends AbstractNamespace
{
    ...
    public function getRollupCaps(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        /** @var Rollup\GetRollupCaps $endpoint */
    ...
    public function getRollupIndexCaps(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        /** @var Rollup\GetRollupIndexCaps $endpoint */
    ...
    public function rollupSearch(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        /** @var Rollup\RollupSearch $endpoint */
