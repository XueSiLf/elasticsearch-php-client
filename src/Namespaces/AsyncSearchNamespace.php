...
class AsyncSearchNamespace extends AbstractNamespace
{
    ...
    public function delete(array $params = [])
    {
        ...
        /** @var Endpoints\AsyncSearch\Delete  $endpoint */
    ...
    public function get(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        /** @var Endpoints\AsyncSearch\Get $endpoint */
    ...
    public function status(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        /** @var Endpoints\AsyncSearch\Status $endpoint */
    ...
    public function submit(array $params = [])
    {
        ...
        $endpointBuilder = $this->endpoints;
        /** @var Endpoints\AsyncSearch\Submit $endpoint */
